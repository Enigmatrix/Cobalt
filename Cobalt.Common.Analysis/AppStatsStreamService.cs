...
namespace Cobalt.Common.Analysis
{
    ...
    public class AppStatsStreamService : IAppStatsStreamService
    {
        ...
        public IObservable<(App App, IObservable<TimeSpan> Duration)> GetAppDurations(DateTime start, DateTime? end = null)
        {
            if (end != null)
            ...
            return Repository.GetAppDurations(start)
                ...
                .GroupBy(x => x.App, x => (x.App, x.Duration), PathEquality)
