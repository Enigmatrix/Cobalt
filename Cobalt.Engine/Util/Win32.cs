...
namespace Cobalt.Engine.Util
{
    public static class Win32
    {
        ...
        public static string ApplicationFrameHost { get; } = @"C:\windows\system32\ApplicationFrameHost.exe";
        ...
        public static Guid GUID_MONITOR_POWER_ON = new Guid(0x02731015, 0x4510, 0x4526, 0x99, 0xE6, 0xE5, 0xA1, 0x7E,
            0xBD, 0x1A, 0xEA);

        public static Guid GUID_ACDC_POWER_SOURCE = new Guid(0x5D3E9A59, 0xE9D5, 0x4B00, 0xA6, 0xBD, 0xFF, 0x34, 0xFF,
            0x51, 0x65, 0x48);

        public static Guid GUID_POWERSCHEME_PERSONALITY = new Guid(0x245D8541, 0x3943, 0x4422, 0xB0, 0x25, 0x13, 0xA7,
            0x84, 0xF6, 0x79, 0xB7);

        public static Guid GUID_MAX_POWER_SAVINGS = new Guid(0xA1841308, 0x3541, 0x4FAB, 0xBC, 0x81, 0xF7, 0x15, 0x56,
            0xF2, 0x0B, 0x4A);

        // No Power Savings - Almost no power savings measures are used.
        public static Guid GUID_MIN_POWER_SAVINGS = new Guid(0x8C5E7FDA, 0xE8BF, 0x4A96, 0x9A, 0x85, 0xA6, 0xE2, 0x3A,
            0x8C, 0x63, 0x5C);

        // Typical Power Savings - Fairly aggressive power savings measures are used.
        public static Guid GUID_TYPICAL_POWER_SAVINGS = new Guid(0x381B4222, 0xF694, 0x41F0, 0x96, 0x85, 0xFF, 0x5B,
            0xB2, 0x60, 0xDF, 0x2E);
        ...
        public const int DEVICE_NOTIFY_CALLBACK = 0x00000002;
        ...
        public enum ClassStyles : uint
        {
            ...
            ///     Because window classes are process specific, it is possible for multiple threads of an application to create a
            ///     window of the same class.
            ///     It is also possible for the threads to attempt to use the device context simultaneously. When this happens, the
            ...
            ///     Typically, this is enabled for small, short-lived windows such as menus to emphasize their Z order relationship to
            ///     other windows.
            /// </summary>
            DropShadow = 0x20000,

            /// <summary>
            ///     Indicates that the window class is an application global class. For more information, see the "Application
            ///     Global Classes" section of About Window Classes.
            /// </summary>
            GlobalClass = 0x4000,
            ...
            ///     parent.
            ///     A window with the CS_PARENTDC style bit receives a regular device context from the system's cache of device
            ///     contexts.
            ///     It does not give the child the parent's device context or device context settings. Specifying CS_PARENTDC enhances
            ...
            ///     When the window is removed, the system uses the saved bitmap to restore the screen image, including other windows
            ///     that were obscured.
            ...
            ///     removed before other screen activity takes place.
            ///     This style increases the time required to display the window, because the system must first allocate memory to
            ///     store the bitmap.
            /// </summary>
            SaveBits = 0x800,
        ...
        public enum WinEvent
        {
            ...
            /// </summary>
            EVENT_SYSTEM_DESKTOPSWITCH = 0X020,
        ...
        [DllImport(@"User32", SetLastError = true, EntryPoint = "RegisterSuspendResumeNotification",
        ...
        /// <param name="lpParam">
        ///     Pointer to a value to be passed to the window through the CREATESTRUCT structure (lpCreateParams member) pointed to
        ///     by the lParam param of the WM_CREATE message. This message is sent to the created window by this function before it
        ///     returns.
        ///     <para>
        ///         If an application calls CreateWindow to create a MDI client window, lpParam should point to a
        ///         CLIENTCREATESTRUCT structure. If an MDI client window calls CreateWindow to create an MDI child window, lpParam
        ///         should point to a MDICREATESTRUCT structure. lpParam may be NULL if no additional data is needed.
        ///     </para>
        /// </param>
        /// <returns>
        ...
        ///     is zero.<br />To get extended error information, call GetLastError.<br />If <see cref="EnumWindowProc" /> returns
